...
export const MODULE_SPRITE_KEYS: Record<ModuleType, string> = {
  ...
  [ModuleType.BarCorner]: 'module.bar_corner',
  [ModuleType.BarEnd]: 'module.bar_end',
  [ModuleType.BoothBank]: 'module.booth_bank',
  [ModuleType.StandingRail]: 'module.standing_rail',
  [ModuleType.ServingLine]: 'module.serving_line',
  [ModuleType.CommunityTable]: 'module.community_table',
  [ModuleType.GuestCabin]: 'module.guest_cabin',
  [ModuleType.ArrivalDesk]: 'module.arrival_desk',
  [ModuleType.WashBank]: 'module.wash_bank',
  ...
  [ModuleType.ReactorCore]: 'module.reactor_core',
