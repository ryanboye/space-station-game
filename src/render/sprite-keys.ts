...
export const MODULE_SPRITE_KEYS: Record<ModuleType, string> = {
  ...
  [ModuleType.Fridge]: 'module.storage_rack',
  [ModuleType.ColdStore]: 'module.storage_rack',
  [ModuleType.PrepCounter]: 'module.workbench',
  [ModuleType.Stove]: 'module.stove',
  [ModuleType.TrayReturn]: 'module.intake_pallet',
  [ModuleType.Dishwasher]: 'module.sink',
  ...
  [ModuleType.FloorDrain]: 'module.water_fountain',
  [ModuleType.WaterValve]: 'module.vent',
