...
const MODULE_FOOTPRINT_BY_KEY = {
  ...
  'module.checkout_bank.damaged': { w: 2, h: 5 },
  ...
  'module.shelf_aisle.damaged': { w: 1, h: 4 },
  'module.display_cold_case': { w: 3, h: 1 },
  'module.display_cold_case.active': { w: 3, h: 1 },
  'module.display_cold_case.empty': { w: 3, h: 1 },
  'module.display_cold_case.dirty': { w: 3, h: 1 },
  'module.display_cold_case.damaged': { w: 3, h: 1 },
  'module.bunk_bank': { w: 2, h: 4 },
  'module.bunk_bank.active': { w: 2, h: 4 },
  'module.bunk_bank.dirty': { w: 2, h: 4 },
  'module.bunk_bank.damaged': { w: 2, h: 4 },
  'module.intake_pallet': { w: 2, h: 2 },
  'module.intake_pallet.empty': { w: 2, h: 2 },
  'module.intake_pallet.light': { w: 2, h: 2 },
  'module.intake_pallet.stocked': { w: 2, h: 2 },
  'module.intake_pallet.full': { w: 2, h: 2 },
  'module.storage_rack': { w: 2, h: 1 },
  'module.storage_rack.empty': { w: 2, h: 1 },
  'module.storage_rack.light': { w: 2, h: 1 },
  'module.storage_rack.stocked': { w: 2, h: 1 },
  'module.storage_rack.full': { w: 2, h: 1 },
  'module.gangway': { w: 1, h: 1 },
  'module.gangway.active': { w: 1, h: 1 },
  'module.customs_counter': { w: 1, h: 1 },
  'module.cargo_arm': { w: 2, h: 2 },
  'module.fuel_tank': { w: 2, h: 2 },
  'module.fuel_pump': { w: 2, h: 1 },
  'module.pod_dock': { w: 2, h: 1 },
  'module.pod_dock.active': { w: 2, h: 1 },
  'module.fuel_coupler': { w: 1, h: 1 },
  'module.freight_locker': { w: 2, h: 1 },
  'module.maintenance_socket': { w: 2, h: 1 },
  'module.berth_control': { w: 2, h: 2 },
  'module.docking_clamp': { w: 1, h: 1 },
  'module.docking_clamp.active': { w: 1, h: 1 },
  ...
  'module.standing_rail.damaged': { w: 1, h: 4 },
  ...
  'module.guest_cabin.damaged': { w: 3, h: 4 },
  ...
  'module.arrival_desk.damaged': { w: 2, h: 4 },
